...
import static tdlm.ToDoPropertyType.TDLM_ITEM_DIALOG_EDIT_HEADER_TEXT;
import static tdlm.ToDoPropertyType.TDLM_ITEM_DIALOG_HEADER;
import static tdlm.ToDoPropertyType.TDLM_ITEM_DIALOG_OK_BUTTON;
import static tdlm.ToDoPropertyType.TDLM_ITEM_DIALOG_START_DATE_PROMPT;
import static tdlm.ToDoPropertyType.TDLM_ITEM_DIALOG_END_DATE_PROMPT;
...
public class ToDoListItemDialog extends Stage {
    ...
    private void initDialog() {
        ...
        initGridNode(assignedToLabel,       TDLM_ITEM_DIALOG_ASSIGNED_TO_PROMPT,    CLASS_TDLM_DIALOG_PROMPT,       0, 5, 5, 1, true);
        initGridNode(assignedToTextField,   null,                                   CLASS_TDLM_DIALOG_TEXT_FIELD,   1, 5, 5, 1, false);        
        initGridNode(completedLabel,        TDLM_ITEM_DIALOG_COMPLETED_PROMPT,      CLASS_TDLM_DIALOG_PROMPT,       0, 7, 2, 1, true);
        initGridNode(completedCheckBox,     TDLM_ITEM_DIALOG_COMPLETED_CHECK_BOX,   CLASS_TDLM_DIALOG_CHECK_BOX,    1, 7, 2, 1, false);
        initGridNode(okCancelPane,          null,                                   CLASS_TDLM_DIALOG_PANE,         0, 8, 3, 1, false);
